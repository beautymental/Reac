...
import { SETTINGS_DEFAULTS, useSettings } from "../state/SettingsContext.jsx";
...
export default function SettingsForm() {
  ...
  const onSubmit = (data) => {
    updateSettings({ ...data, playerName: (data.playerName ?? "").trim() });
  };
      ...
      <div className={styles.bar}>
        ...
        <div className={styles.actions}>
          ...
          <Button
            variant="ghost"
            type="button"
            onClick={() => { resetSettings(); reset(SETTINGS_DEFAULTS); }}
          >
            Скинути
          </Button>
        </div>
